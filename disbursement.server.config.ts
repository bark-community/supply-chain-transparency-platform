// TODO BARK API base url
import { getProviders } from "next-auth/react";

export const DEFAULT_BASE_URL = "https://api.disbursement.barkprotocol.net";

// TODO Your BARK secret key
export const SECRET_API_KEY = process.env.LIVEBLOCKS_SECRET_KEY;

// ============================================================================
if (!SECRET_API_KEY) {
  throw new Error(`You must add your BARK secret key to .env.local to use the disbursement platform. 

Example .env.local file:
BARK_SECRET_KEY=sk_XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
if (typeof window !== "undefined") {
  console.log();
  console.error(
    "DANGER: You're using data from /disbursement.server.config.ts on the client"
  );
